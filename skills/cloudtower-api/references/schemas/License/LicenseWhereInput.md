...
| `max_cluster_num` | integer (int32) | No |  |
| `max_cluster_num_gt` | integer (int32) | No |  |
| `max_cluster_num_gte` | integer (int32) | No |  |
| `max_cluster_num_in` | integer[] | No |  |
| `max_cluster_num_lt` | integer (int32) | No |  |
| `max_cluster_num_lte` | integer (int32) | No |  |
| `max_cluster_num_not` | integer (int32) | No |  |
| `max_cluster_num_not_in` | integer[] | No |  |
| `sign_date` | string | No |  |
