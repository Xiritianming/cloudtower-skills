...
| `system_data_capacity` | integer (int64) | No |  |
| `system_data_capacity_gt` | integer (int64) | No |  |
| `system_data_capacity_gte` | integer (int64) | No |  |
| `system_data_capacity_in` | integer[] | No |  |
| `system_data_capacity_lt` | integer (int64) | No |  |
| `system_data_capacity_lte` | integer (int64) | No |  |
| `system_data_capacity_not` | integer (int64) | No |  |
| `system_data_capacity_not_in` | integer[] | No |  |
| `system_used_data_space` | integer (int64) | No |  |
| `system_used_data_space_gt` | integer (int64) | No |  |
| `system_used_data_space_gte` | integer (int64) | No |  |
| `system_used_data_space_in` | integer[] | No |  |
| `system_used_data_space_lt` | integer (int64) | No |  |
| `system_used_data_space_lte` | integer (int64) | No |  |
| `system_used_data_space_not` | integer (int64) | No |  |
| `system_used_data_space_not_in` | integer[] | No |  |
