...
| `replication_failback_target_executions_every` | any | No |  |
| `replication_failback_target_executions_none` | any | No |  |
| `replication_failback_target_executions_some` | any | No |  |
