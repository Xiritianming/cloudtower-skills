...
| `valid_capacity_in` | integer[] | No |  |
| `valid_capacity_lt` | integer (int64) | No |  |
| `valid_capacity_lte` | integer (int64) | No |  |
| `valid_capacity_not` | integer (int64) | No |  |
| `valid_capacity_not_in` | integer[] | No |  |
| `valid_size` | integer (int64) | No |  |
| `valid_size_gt` | integer (int64) | No |  |
| `valid_size_gte` | integer (int64) | No |  |
| `valid_size_in` | integer[] | No |  |
| `valid_size_lt` | integer (int64) | No |  |
