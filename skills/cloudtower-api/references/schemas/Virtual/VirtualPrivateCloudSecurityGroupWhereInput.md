...
|-------|------|----------|-------------|
| `AND` | Array of [VirtualPrivateCloudSecurityGroupWhereInput](../Virtual/VirtualPrivateCloudSecurityGroupWhereInput.md) | No |  |
| `NOT` | Array of [VirtualPrivateCloudSecurityGroupWhereInput](../Virtual/VirtualPrivateCloudSecurityGroupWhereInput.md) | No |  |
| `OR` | Array of [VirtualPrivateCloudSecurityGroupWhereInput](../Virtual/VirtualPrivateCloudSecurityGroupWhereInput.md) | No |  |
| `default_for_vpc` | boolean | No |  |
| `default_for_vpc_not` | boolean | No |  |
