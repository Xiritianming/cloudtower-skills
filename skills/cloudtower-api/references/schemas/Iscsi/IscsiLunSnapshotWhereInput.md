...
|-------|------|----------|-------------|
| `AND` | Array of [IscsiLunSnapshotWhereInput](../Iscsi/IscsiLunSnapshotWhereInput.md) | No |  |
| `NOT` | Array of [IscsiLunSnapshotWhereInput](../Iscsi/IscsiLunSnapshotWhereInput.md) | No |  |
| `OR` | Array of [IscsiLunSnapshotWhereInput](../Iscsi/IscsiLunSnapshotWhereInput.md) | No |  |
