...
| `estimated_recycling_time_in` | string[] | No |  |
| `estimated_recycling_time_lt` | string | No |  |
| `estimated_recycling_time_lte` | string | No |  |
| `estimated_recycling_time_not` | string | No |  |
| `estimated_recycling_time_not_in` | string[] | No |  |
| `id` | string | No |  |
