...
| `namespace_id_in` | integer[] | No |  |
| `namespace_id_lt` | integer (int32) | No |  |
| `namespace_id_lte` | integer (int32) | No |  |
| `namespace_id_not` | integer (int32) | No |  |
| `namespace_id_not_in` | integer[] | No |  |
