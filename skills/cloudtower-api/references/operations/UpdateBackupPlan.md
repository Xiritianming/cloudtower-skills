# POST /v2/api/update-backup-plan

**Resource:** [BackupPlan](../resources/BackupPlan.md)
**Operation ID:** `UpdateBackupPlan`
...
**Schema:** [BackupPlanUpdationParams](../schemas/Backup/BackupPlanUpdationParams.md)
...
python3 scripts/validate.py UpdateBackupPlan /tmp/body.json
bash scripts/call.sh /v2/api/update-backup-plan /tmp/body.json
```
