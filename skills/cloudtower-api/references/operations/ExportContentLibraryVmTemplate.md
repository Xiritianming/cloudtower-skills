# POST /v2/api/export-content-library-vm-template
...
```bash
python3 scripts/validate.py ExportContentLibraryVmTemplate /tmp/body.json
bash scripts/call.sh /v2/api/export-content-library-vm-template /tmp/body.json
```
