# POST /v2/api/get-virtual-private-clouds-connection
...
```bash
python3 scripts/validate.py GetVirtualPrivateCloudsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-virtual-private-clouds-connection /tmp/body.json
```
