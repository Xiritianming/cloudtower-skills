# POST /v2/api/delete-log-collection
...
python3 scripts/validate.py DeleteLogCollection /tmp/body.json
bash scripts/call.sh /v2/api/delete-log-collection /tmp/body.json
```
