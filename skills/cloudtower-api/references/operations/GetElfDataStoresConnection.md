# POST /v2/api/get-elf-data-stores-connection
...
```bash
python3 scripts/validate.py GetElfDataStoresConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-elf-data-stores-connection /tmp/body.json
```
