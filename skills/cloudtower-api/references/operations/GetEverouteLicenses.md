# POST /v2/api/get-everoute-licenses
...
```bash
python3 scripts/validate.py GetEverouteLicenses /tmp/body.json
bash scripts/call.sh /v2/api/get-everoute-licenses /tmp/body.json
```
