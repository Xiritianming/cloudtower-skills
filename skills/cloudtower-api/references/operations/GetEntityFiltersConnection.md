# POST /v2/api/get-entity-filters-connection
...
python3 scripts/validate.py GetEntityFiltersConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-entity-filters-connection /tmp/body.json
```
