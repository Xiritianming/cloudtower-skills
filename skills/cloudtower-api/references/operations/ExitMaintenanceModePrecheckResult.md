# POST /v2/api/exit-maintance-mode-precheck-result
...
```bash
python3 scripts/validate.py ExitMaintenanceModePrecheckResult /tmp/body.json
bash scripts/call.sh /v2/api/exit-maintance-mode-precheck-result /tmp/body.json
```
