# POST /v2/api/get-deploys-connection
...
```bash
python3 scripts/validate.py GetDeploysConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-deploys-connection /tmp/body.json
```
