# POST /v2/api/get-snmp-trap-receivers-connection
...
```bash
python3 scripts/validate.py GetSnmpTrapReceiversConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-snmp-trap-receivers-connection /tmp/body.json
```
