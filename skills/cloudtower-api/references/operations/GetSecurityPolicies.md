# POST /v2/api/get-security-policies
...
```bash
python3 scripts/validate.py GetSecurityPolicies /tmp/body.json
bash scripts/call.sh /v2/api/get-security-policies /tmp/body.json
```
