# POST /v2/api/get-nvmf-namespace-snapshots-connection
...
```bash
python3 scripts/validate.py GetNvmfNamespaceSnapshotsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-nvmf-namespace-snapshots-connection /tmp/body.json
```
