# POST /v2/api/get-upload-tasks-connection
...
python3 scripts/validate.py GetUploadTasksConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-upload-tasks-connection /tmp/body.json
```
