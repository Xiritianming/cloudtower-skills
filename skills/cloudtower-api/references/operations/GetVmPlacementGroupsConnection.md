# POST /v2/api/get-vm-placement-groups-connection
...
python3 scripts/validate.py GetVmPlacementGroupsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-vm-placement-groups-connection /tmp/body.json
```
