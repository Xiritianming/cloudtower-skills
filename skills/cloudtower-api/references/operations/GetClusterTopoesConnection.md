# POST /v2/api/get-cluster-topoes-connection
...
```bash
python3 scripts/validate.py GetClusterTopoesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-cluster-topoes-connection /tmp/body.json
```
