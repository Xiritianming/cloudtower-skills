# POST /v2/api/update-consistency-group
...
```bash
python3 scripts/validate.py UpdateConsistencyGroup /tmp/body.json
bash scripts/call.sh /v2/api/update-consistency-group /tmp/body.json
```
