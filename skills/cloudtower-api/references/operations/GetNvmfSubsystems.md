# POST /v2/api/get-nvmf-subsystems
...
```bash
python3 scripts/validate.py GetNvmfSubsystems /tmp/body.json
bash scripts/call.sh /v2/api/get-nvmf-subsystems /tmp/body.json
```
