# POST /v2/api/delete-iscsi-lun-snapshot
...
```bash
python3 scripts/validate.py DeleteIscsiLunSnapshot /tmp/body.json
bash scripts/call.sh /v2/api/delete-iscsi-lun-snapshot /tmp/body.json
```
