# POST /v2/api/get-vm-export-files
...
python3 scripts/validate.py GetVmExportFiles /tmp/body.json
bash scripts/call.sh /v2/api/get-vm-export-files /tmp/body.json
```
