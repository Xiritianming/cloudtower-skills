# POST /v2/api/upgrade-cloudtower-application
...
```bash
python3 scripts/validate.py UpgradeCloudTowerApplication /tmp/body.json
bash scripts/call.sh /v2/api/upgrade-cloudtower-application /tmp/body.json
```
