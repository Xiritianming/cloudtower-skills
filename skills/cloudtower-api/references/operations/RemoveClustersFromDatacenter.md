# POST /v2/api/remove-clusters-from-datacenter
...
python3 scripts/validate.py RemoveClustersFromDatacenter /tmp/body.json
bash scripts/call.sh /v2/api/remove-clusters-from-datacenter /tmp/body.json
```
