# POST /v2/api/create-security-group
...
```bash
python3 scripts/validate.py CreateSecurityGroup /tmp/body.json
bash scripts/call.sh /v2/api/create-security-group /tmp/body.json
```
