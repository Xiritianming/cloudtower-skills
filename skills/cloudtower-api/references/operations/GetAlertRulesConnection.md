# POST /v2/api/get-alert-rules-connection
...
```bash
python3 scripts/validate.py GetAlertRulesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-alert-rules-connection /tmp/body.json
```
