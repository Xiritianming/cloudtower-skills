# POST /v2/api/get-elf-storage-policies-connection
...
```bash
python3 scripts/validate.py GetElfStoragePoliciesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-elf-storage-policies-connection /tmp/body.json
```
