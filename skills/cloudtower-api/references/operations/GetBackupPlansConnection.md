# POST /v2/api/get-backup-plans-connection
...
```bash
python3 scripts/validate.py GetBackupPlansConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-backup-plans-connection /tmp/body.json
```
