# POST /v2/api/delete-network-policy-rule-service
...
python3 scripts/validate.py DeleteNetworkPolicyRuleService /tmp/body.json
bash scripts/call.sh /v2/api/delete-network-policy-rule-service /tmp/body.json
```
