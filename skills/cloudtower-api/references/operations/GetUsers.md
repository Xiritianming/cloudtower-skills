...
**Schema:** [GetUsersRequestBody](../schemas/Get/GetUsersRequestBody.md)
...
python3 scripts/validate.py GetUsers /tmp/body.json
bash scripts/call.sh /v2/api/get-users /tmp/body.json
```
