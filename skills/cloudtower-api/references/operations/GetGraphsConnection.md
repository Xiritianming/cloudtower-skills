# POST /v2/api/get-graphs-connection
...
python3 scripts/validate.py GetGraphsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-graphs-connection /tmp/body.json
```
