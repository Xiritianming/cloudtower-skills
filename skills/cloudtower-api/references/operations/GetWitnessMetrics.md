# POST /v2/api/get-witness-metrics

**Resource:** [Metrics](../resources/Metrics.md)
**Operation ID:** `GetWitnessMetrics`
...
**Schema:** [GetWitnessMetricInput](../schemas/Get/GetWitnessMetricInput.md)
...
python3 scripts/validate.py GetWitnessMetrics /tmp/body.json
bash scripts/call.sh /v2/api/get-witness-metrics /tmp/body.json
```
