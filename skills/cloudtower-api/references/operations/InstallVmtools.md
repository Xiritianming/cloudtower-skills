# POST /v2/api/install-vmtools

**Resource:** [Vm](../resources/Vm.md)
**Operation ID:** `InstallVmtools`
...
**Schema:** [InstallVmtoolsParams](../schemas/Install/InstallVmtoolsParams.md)
...
python3 scripts/validate.py InstallVmtools /tmp/body.json
bash scripts/call.sh /v2/api/install-vmtools /tmp/body.json
```
