# POST /v2/api/get-vdses-connection
...
```bash
python3 scripts/validate.py GetVdsesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-vdses-connection /tmp/body.json
```
