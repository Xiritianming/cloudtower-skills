# POST /v2/api/get-snmp-transports
...
python3 scripts/validate.py GetSnmpTransports /tmp/body.json
bash scripts/call.sh /v2/api/get-snmp-transports /tmp/body.json
```
