# POST /v2/api/get-everoute-clusters-connection
...
```bash
python3 scripts/validate.py GetEverouteClustersConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-everoute-clusters-connection /tmp/body.json
```
