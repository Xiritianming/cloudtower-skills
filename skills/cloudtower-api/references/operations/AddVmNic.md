# POST /v2/api/add-vm-nic

**Resource:** [Vm](../resources/Vm.md)
**Operation ID:** `AddVmNic`
...
**Schema:** [VmAddNicParams](../schemas/Vm/VmAddNicParams.md)
...
```bash
python3 scripts/validate.py AddVmNic /tmp/body.json
bash scripts/call.sh /v2/api/add-vm-nic /tmp/body.json
```
