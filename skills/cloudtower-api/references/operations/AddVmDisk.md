# POST /v2/api/add-vm-disk

**Resource:** [Vm](../resources/Vm.md)
**Operation ID:** `AddVmDisk`
...
**Schema:** [VmAddDiskParams](../schemas/Vm/VmAddDiskParams.md)
...
```bash
python3 scripts/validate.py AddVmDisk /tmp/body.json
bash scripts/call.sh /v2/api/add-vm-disk /tmp/body.json
```
