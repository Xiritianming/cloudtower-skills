# POST /v2/api/get-vm-templates-connection
...
python3 scripts/validate.py GetVmTemplatesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-vm-templates-connection /tmp/body.json
```
