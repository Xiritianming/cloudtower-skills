# POST /v2/api/get-everoute-packages
...
```bash
python3 scripts/validate.py GetEveroutePackages /tmp/body.json
bash scripts/call.sh /v2/api/get-everoute-packages /tmp/body.json
```
