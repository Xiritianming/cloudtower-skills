# POST /v2/api/get-virtual-private-cloud-route-tables
...
python3 scripts/validate.py GetVirtualPrivateCloudRouteTables /tmp/body.json
bash scripts/call.sh /v2/api/get-virtual-private-cloud-route-tables /tmp/body.json
```
