# POST /v2/api/get-vm-volume-metrics
...
python3 scripts/validate.py GetVmVolumeMetrics /tmp/body.json
bash scripts/call.sh /v2/api/get-vm-volume-metrics /tmp/body.json
```
