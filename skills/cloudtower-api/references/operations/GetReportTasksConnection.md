# POST /v2/api/get-report-tasks-connection
...
```bash
python3 scripts/validate.py GetReportTasksConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-report-tasks-connection /tmp/body.json
```
