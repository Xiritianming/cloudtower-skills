# POST /v2/api/get-replication-plans-without-executions
...
```bash
python3 scripts/validate.py GetReplicationPlanWithoutExecutions /tmp/body.json
bash scripts/call.sh /v2/api/get-replication-plans-without-executions /tmp/body.json
```
