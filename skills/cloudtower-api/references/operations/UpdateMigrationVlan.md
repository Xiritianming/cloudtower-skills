# POST /v2/api/update-migration-vlan
...
```bash
python3 scripts/validate.py UpdateMigrationVlan /tmp/body.json
bash scripts/call.sh /v2/api/update-migration-vlan /tmp/body.json
```
