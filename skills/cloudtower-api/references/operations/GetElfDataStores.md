# POST /v2/api/get-elf-data-stores
...
```bash
python3 scripts/validate.py GetElfDataStores /tmp/body.json
bash scripts/call.sh /v2/api/get-elf-data-stores /tmp/body.json
```
