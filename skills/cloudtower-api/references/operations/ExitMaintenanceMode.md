# POST /v2/api/exit-maintance-mode
...
```bash
python3 scripts/validate.py ExitMaintenanceMode /tmp/body.json
bash scripts/call.sh /v2/api/exit-maintance-mode /tmp/body.json
```
