# POST /v2/api/update-cluster-ha-setting
...
```bash
python3 scripts/validate.py UpdateClusterHaSetting /tmp/body.json
bash scripts/call.sh /v2/api/update-cluster-ha-setting /tmp/body.json
```
