# POST /v2/api/get-system-audit-logs-connection
...
python3 scripts/validate.py GetSystemAuditLogsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-system-audit-logs-connection /tmp/body.json
```
