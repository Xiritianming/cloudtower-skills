# POST /v2/api/get-rack-topoes-connection
...
python3 scripts/validate.py GetRackTopoesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-rack-topoes-connection /tmp/body.json
```
