# POST /v2/api/get-cluster-settingses
...
```bash
python3 scripts/validate.py GetClusterSettingses /tmp/body.json
bash scripts/call.sh /v2/api/get-cluster-settingses /tmp/body.json
```
