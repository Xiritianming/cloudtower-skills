# POST /v2/api/create-virtual-private-cloud-route-table
...
python3 scripts/validate.py CreateVirtualPrivateCloudRouteTable /tmp/body.json
bash scripts/call.sh /v2/api/create-virtual-private-cloud-route-table /tmp/body.json
```
