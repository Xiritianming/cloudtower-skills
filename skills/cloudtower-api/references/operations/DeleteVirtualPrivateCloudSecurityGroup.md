# POST /v2/api/delete-virtual-private-cloud-security-group
...
```bash
python3 scripts/validate.py DeleteVirtualPrivateCloudSecurityGroup /tmp/body.json
bash scripts/call.sh /v2/api/delete-virtual-private-cloud-security-group /tmp/body.json
```
