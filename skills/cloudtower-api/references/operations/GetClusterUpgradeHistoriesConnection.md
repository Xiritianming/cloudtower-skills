# POST /v2/api/get-cluster-upgrade-histories-connection
...
python3 scripts/validate.py GetClusterUpgradeHistoriesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-cluster-upgrade-histories-connection /tmp/body.json
```
