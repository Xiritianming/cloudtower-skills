# POST /v2/api/enter-maintenance-mode-precheck
...
```bash
python3 scripts/validate.py EnterMaintenanceModePreCheck /tmp/body.json
bash scripts/call.sh /v2/api/enter-maintenance-mode-precheck /tmp/body.json
```
