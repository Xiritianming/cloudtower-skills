# POST /v2/api/disassociate-system-service-from-obs-service
...
python3 scripts/validate.py DisassociateSystemServiceFromObsService /tmp/body.json
bash scripts/call.sh /v2/api/disassociate-system-service-from-obs-service /tmp/body.json
```
