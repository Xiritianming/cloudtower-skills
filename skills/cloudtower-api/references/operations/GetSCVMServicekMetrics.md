# POST /v2/api/get-scvm-service-metrics
...
```bash
python3 scripts/validate.py GetSCVMServicekMetrics /tmp/body.json
bash scripts/call.sh /v2/api/get-scvm-service-metrics /tmp/body.json
```
