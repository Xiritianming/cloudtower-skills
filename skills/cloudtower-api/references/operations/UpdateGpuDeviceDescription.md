# POST /v2/api/update-gpu-device-description
...
```bash
python3 scripts/validate.py UpdateGpuDeviceDescription /tmp/body.json
bash scripts/call.sh /v2/api/update-gpu-device-description /tmp/body.json
```
