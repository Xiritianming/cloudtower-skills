# POST /v2/api/get-vcenter-accounts-connection
...
```bash
python3 scripts/validate.py GetVcenterAccountsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-vcenter-accounts-connection /tmp/body.json
```
