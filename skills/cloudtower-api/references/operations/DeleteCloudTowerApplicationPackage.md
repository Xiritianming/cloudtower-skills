# POST /v2/api/delete-cloudtower-application-package
...
```bash
python3 scripts/validate.py DeleteCloudTowerApplicationPackage /tmp/body.json
bash scripts/call.sh /v2/api/delete-cloudtower-application-package /tmp/body.json
```
