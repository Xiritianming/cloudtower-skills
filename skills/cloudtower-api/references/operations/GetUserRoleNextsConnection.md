# POST /v2/api/get-user-role-nexts-connection
...
python3 scripts/validate.py GetUserRoleNextsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-user-role-nexts-connection /tmp/body.json
```
