# POST /v2/api/import-content-library-image
...
python3 scripts/validate.py ImportContentLibraryImage /tmp/body.json
bash scripts/call.sh /v2/api/import-content-library-image /tmp/body.json
```
