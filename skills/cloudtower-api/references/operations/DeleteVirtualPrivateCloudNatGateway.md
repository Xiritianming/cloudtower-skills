# POST /v2/api/delete-virtual-private-cloud-nat-gateway
...
```bash
python3 scripts/validate.py DeleteVirtualPrivateCloudNatGateway /tmp/body.json
bash scripts/call.sh /v2/api/delete-virtual-private-cloud-nat-gateway /tmp/body.json
```
