# POST /v2/api/delete-entity-filter
...
python3 scripts/validate.py DeleteEntityFilter /tmp/body.json
bash scripts/call.sh /v2/api/delete-entity-filter /tmp/body.json
```
