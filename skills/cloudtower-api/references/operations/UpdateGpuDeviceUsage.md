# POST /v2/api/update-gpu-device-usage
...
```bash
python3 scripts/validate.py UpdateGpuDeviceUsage /tmp/body.json
bash scripts/call.sh /v2/api/update-gpu-device-usage /tmp/body.json
```
