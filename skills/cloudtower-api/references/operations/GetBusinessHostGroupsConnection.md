# POST /v2/api/get-business-host-groups-connection
...
```bash
python3 scripts/validate.py GetBusinessHostGroupsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-business-host-groups-connection /tmp/body.json
```
