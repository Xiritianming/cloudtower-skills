# POST /v2/api/get-datacenters-connection
...
```bash
python3 scripts/validate.py GetDatacentersConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-datacenters-connection /tmp/body.json
```
