# POST /v2/api/stop-vm-in-cutover-migration
...
python3 scripts/validate.py StopVmInCutoverMigration /tmp/body.json
bash scripts/call.sh /v2/api/stop-vm-in-cutover-migration /tmp/body.json
```
