# POST /v2/api/get-virtual-private-cloud-router-gateways
...
```bash
python3 scripts/validate.py GetVirtualPrivateCloudRouterGateways /tmp/body.json
bash scripts/call.sh /v2/api/get-virtual-private-cloud-router-gateways /tmp/body.json
```
