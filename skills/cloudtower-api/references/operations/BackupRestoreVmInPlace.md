# POST /v2/api/backup-restore-vm-in-place
...
```bash
python3 scripts/validate.py BackupRestoreVmInPlace /tmp/body.json
bash scripts/call.sh /v2/api/backup-restore-vm-in-place /tmp/body.json
```
