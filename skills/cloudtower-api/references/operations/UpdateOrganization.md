# POST /v2/api/update-organization
...
**Schema:** [OrganizationUpdationParams](../schemas/Organization/OrganizationUpdationParams.md)
...
python3 scripts/validate.py UpdateOrganization /tmp/body.json
bash scripts/call.sh /v2/api/update-organization /tmp/body.json
```
