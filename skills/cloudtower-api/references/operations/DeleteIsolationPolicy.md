# POST /v2/api/delete-isolation-policy
...
```bash
python3 scripts/validate.py DeleteIsolationPolicy /tmp/body.json
bash scripts/call.sh /v2/api/delete-isolation-policy /tmp/body.json
```
