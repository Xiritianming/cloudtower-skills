# POST /v2/api/uninstall-cloudtower-application
...
python3 scripts/validate.py UninstallCloudTowerApplication /tmp/body.json
bash scripts/call.sh /v2/api/uninstall-cloudtower-application /tmp/body.json
```
