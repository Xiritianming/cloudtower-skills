# POST /v2/api/get-pmem-dimms-connection
...
```bash
python3 scripts/validate.py GetPmemDimmsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-pmem-dimms-connection /tmp/body.json
```
