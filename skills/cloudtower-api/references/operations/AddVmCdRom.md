# POST /v2/api/add-vm-cd-rom

**Resource:** [Vm](../resources/Vm.md)
**Operation ID:** `AddVmCdRom`
...
**Schema:** [VmAddCdRomParams](../schemas/Vm/VmAddCdRomParams.md)
...
python3 scripts/validate.py AddVmCdRom /tmp/body.json
bash scripts/call.sh /v2/api/add-vm-cd-rom /tmp/body.json
```
