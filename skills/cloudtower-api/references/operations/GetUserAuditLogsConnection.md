# POST /v2/api/get-user-audit-logs-connection
...
python3 scripts/validate.py GetUserAuditLogsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-user-audit-logs-connection /tmp/body.json
```
