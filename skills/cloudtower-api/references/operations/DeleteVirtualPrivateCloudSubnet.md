# POST /v2/api/delete-virtual-private-cloud-subnet
...
```bash
python3 scripts/validate.py DeleteVirtualPrivateCloudSubnet /tmp/body.json
bash scripts/call.sh /v2/api/delete-virtual-private-cloud-subnet /tmp/body.json
```
