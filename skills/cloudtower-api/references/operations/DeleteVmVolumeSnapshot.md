# POST /v2/api/delete-vm-volume-snapshot
...
```bash
python3 scripts/validate.py DeleteVmVolumeSnapshot /tmp/body.json
bash scripts/call.sh /v2/api/delete-vm-volume-snapshot /tmp/body.json
```
