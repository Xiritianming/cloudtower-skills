# POST /v2/api/delete-virtual-private-cloud-floating-ip
...
```bash
python3 scripts/validate.py DeleteVirtualPrivateCloudFloatingIp /tmp/body.json
bash scripts/call.sh /v2/api/delete-virtual-private-cloud-floating-ip /tmp/body.json
```
