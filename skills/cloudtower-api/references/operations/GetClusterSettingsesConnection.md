# POST /v2/api/get-cluster-settingses-connection
...
```bash
python3 scripts/validate.py GetClusterSettingsesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-cluster-settingses-connection /tmp/body.json
```
