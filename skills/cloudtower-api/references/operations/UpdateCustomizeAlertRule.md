# POST /v2/api/update-customize-alert-rule
...
```bash
python3 scripts/validate.py UpdateCustomizeAlertRule /tmp/body.json
bash scripts/call.sh /v2/api/update-customize-alert-rule /tmp/body.json
```
