# POST /v2/api/create-vm-from-content-library-template-batch
...
```bash
python3 scripts/validate.py CreateVmFromContentLibraryTemplateBatch /tmp/body.json
bash scripts/call.sh /v2/api/create-vm-from-content-library-template-batch /tmp/body.json
```
