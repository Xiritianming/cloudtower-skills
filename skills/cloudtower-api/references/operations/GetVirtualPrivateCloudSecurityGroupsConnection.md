# POST /v2/api/get-virtual-private-cloud-security-groups-connection
...
python3 scripts/validate.py GetVirtualPrivateCloudSecurityGroupsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-virtual-private-cloud-security-groups-connection /tmp/body.json
```
