# POST /v2/api/delete-namespace-group
...
```bash
python3 scripts/validate.py DeleteNamespaceGroup /tmp/body.json
bash scripts/call.sh /v2/api/delete-namespace-group /tmp/body.json
```
