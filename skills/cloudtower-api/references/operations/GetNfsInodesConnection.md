# POST /v2/api/get-nfs-inodes-connection
...
```bash
python3 scripts/validate.py GetNfsInodesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-nfs-inodes-connection /tmp/body.json
```
