# POST /v2/api/get-everoute-clusters
...
```bash
python3 scripts/validate.py GetEverouteClusters /tmp/body.json
bash scripts/call.sh /v2/api/get-everoute-clusters /tmp/body.json
```
