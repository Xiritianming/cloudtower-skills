# POST /v2/api/get-user-audit-logs
...
```bash
python3 scripts/validate.py GetUserAuditLogs /tmp/body.json
bash scripts/call.sh /v2/api/get-user-audit-logs /tmp/body.json
```
