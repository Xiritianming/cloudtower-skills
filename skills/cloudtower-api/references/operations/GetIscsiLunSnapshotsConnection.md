# POST /v2/api/get-iscsi-lun-snapshots-connection
...
```bash
python3 scripts/validate.py GetIscsiLunSnapshotsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-iscsi-lun-snapshots-connection /tmp/body.json
```
