# POST /v2/api/create-iscsi-lun-snapshot
...
python3 scripts/validate.py CreateIscsiLunSnapshot /tmp/body.json
bash scripts/call.sh /v2/api/create-iscsi-lun-snapshot /tmp/body.json
```
