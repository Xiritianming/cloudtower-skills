# POST /v2/api/update-isolation-policy
...
```bash
python3 scripts/validate.py UpdateIsolationPolicy /tmp/body.json
bash scripts/call.sh /v2/api/update-isolation-policy /tmp/body.json
```
