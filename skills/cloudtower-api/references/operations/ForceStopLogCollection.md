# POST /v2/api/force-stop-log-collection

**Resource:** [LogCollection](../resources/LogCollection.md)
**Operation ID:** `ForceStopLogCollection`
...
**Schema:** [ForceStopLogCollectionParams](../schemas/Force/ForceStopLogCollectionParams.md)
...
python3 scripts/validate.py ForceStopLogCollection /tmp/body.json
bash scripts/call.sh /v2/api/force-stop-log-collection /tmp/body.json
```
