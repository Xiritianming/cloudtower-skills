# POST /v2/api/update-cluster-license
...
```bash
python3 scripts/validate.py UpdateClusterLicense /tmp/body.json
bash scripts/call.sh /v2/api/update-cluster-license /tmp/body.json
```
