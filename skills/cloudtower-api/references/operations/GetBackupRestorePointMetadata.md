# POST /v2/api/get-backup-restore-point-metadata
...
```bash
python3 scripts/validate.py GetBackupRestorePointMetadata /tmp/body.json
bash scripts/call.sh /v2/api/get-backup-restore-point-metadata /tmp/body.json
```
