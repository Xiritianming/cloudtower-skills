# POST /v2/api/get-cluster-metrics

**Resource:** [Metrics](../resources/Metrics.md)
**Operation ID:** `GetClusterMetrics`
...
**Schema:** [GetClusterMetricInput](../schemas/Get/GetClusterMetricInput.md)
...
python3 scripts/validate.py GetClusterMetrics /tmp/body.json
bash scripts/call.sh /v2/api/get-cluster-metrics /tmp/body.json
```
