...
**Schema:** [RoleUpdationParams](../schemas/Role/RoleUpdationParams.md)
...
```bash
python3 scripts/validate.py UpdateRole /tmp/body.json
bash scripts/call.sh /v2/api/update-role /tmp/body.json
```
