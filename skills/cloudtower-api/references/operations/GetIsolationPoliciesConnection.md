# POST /v2/api/get-isolation-policies-connection
...
```bash
python3 scripts/validate.py GetIsolationPoliciesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-isolation-policies-connection /tmp/body.json
```
