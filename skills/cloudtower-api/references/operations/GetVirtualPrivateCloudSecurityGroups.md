# POST /v2/api/get-virtual-private-cloud-security-groups
...
```bash
python3 scripts/validate.py GetVirtualPrivateCloudSecurityGroups /tmp/body.json
bash scripts/call.sh /v2/api/get-virtual-private-cloud-security-groups /tmp/body.json
```
