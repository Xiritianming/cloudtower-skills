# POST /v2/api/create-consistency-snapshot-group
...
```bash
python3 scripts/validate.py CreateConsistencyGroupSnapshot /tmp/body.json
bash scripts/call.sh /v2/api/create-consistency-snapshot-group /tmp/body.json
```
