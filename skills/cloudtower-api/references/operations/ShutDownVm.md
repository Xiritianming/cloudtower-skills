# POST /v2/api/shutdown-vm

**Resource:** [Vm](../resources/Vm.md)
**Operation ID:** `ShutDownVm`
...
```bash
python3 scripts/validate.py ShutDownVm /tmp/body.json
bash scripts/call.sh /v2/api/shutdown-vm /tmp/body.json
```
