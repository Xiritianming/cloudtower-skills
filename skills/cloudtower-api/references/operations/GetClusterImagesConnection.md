# POST /v2/api/get-cluster-images-connection
...
```bash
python3 scripts/validate.py GetClusterImagesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-cluster-images-connection /tmp/body.json
```
