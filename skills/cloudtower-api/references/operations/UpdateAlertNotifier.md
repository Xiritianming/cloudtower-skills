# POST /v2/api/update-alert-notifier
...
```bash
python3 scripts/validate.py UpdateAlertNotifier /tmp/body.json
bash scripts/call.sh /v2/api/update-alert-notifier /tmp/body.json
```
