# POST /v2/api/get-virtual-private-cloud-nat-gateways
...
python3 scripts/validate.py GetVirtualPrivateCloudNatGateways /tmp/body.json
bash scripts/call.sh /v2/api/get-virtual-private-cloud-nat-gateways /tmp/body.json
```
