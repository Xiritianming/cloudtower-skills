...
**Schema:** [ViewUpdationParams](../schemas/View/ViewUpdationParams.md)
...
```bash
python3 scripts/validate.py UpdateView /tmp/body.json
bash scripts/call.sh /v2/api/update-view /tmp/body.json
```
