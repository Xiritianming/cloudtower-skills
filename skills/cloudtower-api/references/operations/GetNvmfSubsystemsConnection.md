# POST /v2/api/get-nvmf-subsystems-connection
...
python3 scripts/validate.py GetNvmfSubsystemsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-nvmf-subsystems-connection /tmp/body.json
```
