# POST /v2/api/get-virtual-private-cloud-edge-gateway-groups
...
```bash
python3 scripts/validate.py GetVirtualPrivateCloudEdgeGatewayGroups /tmp/body.json
bash scripts/call.sh /v2/api/get-virtual-private-cloud-edge-gateway-groups /tmp/body.json
```
