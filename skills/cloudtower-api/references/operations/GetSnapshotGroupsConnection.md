# POST /v2/api/get-snapshot-groups-connection
...
python3 scripts/validate.py GetSnapshotGroupsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-snapshot-groups-connection /tmp/body.json
```
