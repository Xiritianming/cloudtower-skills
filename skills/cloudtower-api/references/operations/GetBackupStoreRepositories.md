# POST /v2/api/get-backup-store-repositories
...
```bash
python3 scripts/validate.py GetBackupStoreRepositories /tmp/body.json
bash scripts/call.sh /v2/api/get-backup-store-repositories /tmp/body.json
```
