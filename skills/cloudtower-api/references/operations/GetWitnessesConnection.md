# POST /v2/api/get-witnesses-connection
...
python3 scripts/validate.py GetWitnessesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-witnesses-connection /tmp/body.json
```
