# POST /v2/api/delete-virtual-private-cloud
...
python3 scripts/validate.py DeleteVirtualPrivateCloud /tmp/body.json
bash scripts/call.sh /v2/api/delete-virtual-private-cloud /tmp/body.json
```
