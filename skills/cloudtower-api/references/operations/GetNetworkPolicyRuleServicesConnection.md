# POST /v2/api/get-network-policy-rule-services-connection
...
```bash
python3 scripts/validate.py GetNetworkPolicyRuleServicesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-network-policy-rule-services-connection /tmp/body.json
```
