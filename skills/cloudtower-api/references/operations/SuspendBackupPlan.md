# POST /v2/api/suspend-backup-plan
...
```bash
python3 scripts/validate.py SuspendBackupPlan /tmp/body.json
bash scripts/call.sh /v2/api/suspend-backup-plan /tmp/body.json
```
