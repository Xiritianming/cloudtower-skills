# POST /v2/api/get-iscsi-connections-connection
...
```bash
python3 scripts/validate.py GetIscsiConnectionsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-iscsi-connections-connection /tmp/body.json
```
