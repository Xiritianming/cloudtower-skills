# POST /v2/api/get-nfs-exports-connection
...
python3 scripts/validate.py GetNfsExportsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-nfs-exports-connection /tmp/body.json
```
