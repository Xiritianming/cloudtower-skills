# POST /v2/api/remove-vm-from-folder

**Resource:** [Vm](../resources/Vm.md)
**Operation ID:** `RemoveVmToFolder`
...
python3 scripts/validate.py RemoveVmToFolder /tmp/body.json
bash scripts/call.sh /v2/api/remove-vm-from-folder /tmp/body.json
```
