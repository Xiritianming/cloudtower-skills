# POST /v2/api/create-organization
...
```bash
python3 scripts/validate.py CreateOrganization /tmp/body.json
bash scripts/call.sh /v2/api/create-organization /tmp/body.json
```
