# POST /v2/api/get-global-settingses-connection
...
python3 scripts/validate.py GetGlobalSettingsesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-global-settingses-connection /tmp/body.json
```
