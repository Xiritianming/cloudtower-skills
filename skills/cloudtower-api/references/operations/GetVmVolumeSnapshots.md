# POST /v2/api/get-vm-volume-snapshots
...
```bash
python3 scripts/validate.py GetVmVolumeSnapshots /tmp/body.json
bash scripts/call.sh /v2/api/get-vm-volume-snapshots /tmp/body.json
```
