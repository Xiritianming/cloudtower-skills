# POST /v2/api/get-vm-disks-connection
...
python3 scripts/validate.py GetVmDisksConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-vm-disks-connection /tmp/body.json
```
