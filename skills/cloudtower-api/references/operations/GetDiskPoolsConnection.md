# POST /v2/api/get-disk-pools-connection
...
```bash
python3 scripts/validate.py GetDiskPoolsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-disk-pools-connection /tmp/body.json
```
