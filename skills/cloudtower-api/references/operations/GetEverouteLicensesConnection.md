# POST /v2/api/get-everoute-licenses-connection
...
```bash
python3 scripts/validate.py GetEverouteLicensesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-everoute-licenses-connection /tmp/body.json
```
