# POST /v2/api/disable-cluster-pin-in-performance
...
python3 scripts/validate.py UpdateClusterDisablePinInPerformance /tmp/body.json
bash scripts/call.sh /v2/api/disable-cluster-pin-in-performance /tmp/body.json
```
