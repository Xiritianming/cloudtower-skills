# POST /v2/api/update-datacenter

**Resource:** [Datacenter](../resources/Datacenter.md)
**Operation ID:** `UpdateDatacenter`
...
**Schema:** [DatacenterUpdationParams](../schemas/Datacenter/DatacenterUpdationParams.md)
...
python3 scripts/validate.py UpdateDatacenter /tmp/body.json
bash scripts/call.sh /v2/api/update-datacenter /tmp/body.json
```
