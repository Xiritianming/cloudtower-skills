# POST /v2/api/update-cluster-recycle-bin-setting

**Resource:** [GlobalSettings](../resources/GlobalSettings.md)
**Operation ID:** `UpdateClusterRecycleBinSetting`
...
**Schema:** [ClusterRecycleBinUpdationParams](../schemas/Cluster/ClusterRecycleBinUpdationParams.md)
...
python3 scripts/validate.py UpdateClusterRecycleBinSetting /tmp/body.json
bash scripts/call.sh /v2/api/update-cluster-recycle-bin-setting /tmp/body.json
```
