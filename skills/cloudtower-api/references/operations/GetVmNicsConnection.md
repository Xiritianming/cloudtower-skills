# POST /v2/api/get-vm-nics-connection
...
```bash
python3 scripts/validate.py GetVmNicsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-vm-nics-connection /tmp/body.json
```
