# POST /v2/api/get-backup-restore-executions
...
python3 scripts/validate.py GetBackupRestoreExecutions /tmp/body.json
bash scripts/call.sh /v2/api/get-backup-restore-executions /tmp/body.json
```
