# POST /v2/api/get-labels-connection
...
python3 scripts/validate.py GetLabelsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-labels-connection /tmp/body.json
```
