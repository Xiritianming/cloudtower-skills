# POST /v2/api/update-vm-host-options
...
```bash
python3 scripts/validate.py UpdateVmHostOptions /tmp/body.json
bash scripts/call.sh /v2/api/update-vm-host-options /tmp/body.json
```
