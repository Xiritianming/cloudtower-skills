# POST /v2/api/get-replica-vms-connection
...
```bash
python3 scripts/validate.py GetReplicaVmsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-replica-vms-connection /tmp/body.json
```
