# POST /v2/api/update-security-group
...
```bash
python3 scripts/validate.py UpdateSecurityGroup /tmp/body.json
bash scripts/call.sh /v2/api/update-security-group /tmp/body.json
```
