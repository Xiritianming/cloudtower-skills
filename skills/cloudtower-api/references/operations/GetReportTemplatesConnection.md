# POST /v2/api/get-report-templates-connection
...
python3 scripts/validate.py GetReportTemplatesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-report-templates-connection /tmp/body.json
```
