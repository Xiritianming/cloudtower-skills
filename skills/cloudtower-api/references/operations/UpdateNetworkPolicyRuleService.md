# POST /v2/api/update-network-policy-rule-service
...
python3 scripts/validate.py UpdateNetworkPolicyRuleService /tmp/body.json
bash scripts/call.sh /v2/api/update-network-policy-rule-service /tmp/body.json
```
