# POST /v2/api/update-vm-nic-qos-option
...
```bash
python3 scripts/validate.py UpdateVmNicQosOption /tmp/body.json
bash scripts/call.sh /v2/api/update-vm-nic-qos-option /tmp/body.json
```
