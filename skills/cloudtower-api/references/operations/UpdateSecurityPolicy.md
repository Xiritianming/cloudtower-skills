# POST /v2/api/update-security-policy
...
```bash
python3 scripts/validate.py UpdateSecurityPolicy /tmp/body.json
bash scripts/call.sh /v2/api/update-security-policy /tmp/body.json
```
