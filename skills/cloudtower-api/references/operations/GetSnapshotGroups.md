# POST /v2/api/get-snapshot-groups
...
```bash
python3 scripts/validate.py GetSnapshotGroups /tmp/body.json
bash scripts/call.sh /v2/api/get-snapshot-groups /tmp/body.json
```
