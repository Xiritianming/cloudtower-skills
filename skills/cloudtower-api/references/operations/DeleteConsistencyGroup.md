# POST /v2/api/delete-consistency-group
...
```bash
python3 scripts/validate.py DeleteConsistencyGroup /tmp/body.json
bash scripts/call.sh /v2/api/delete-consistency-group /tmp/body.json
```
