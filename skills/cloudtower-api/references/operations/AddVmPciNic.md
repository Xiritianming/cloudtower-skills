# POST /v2/api/add-vm-pci-nic

**Resource:** [Vm](../resources/Vm.md)
**Operation ID:** `AddVmPciNic`
...
python3 scripts/validate.py AddVmPciNic /tmp/body.json
bash scripts/call.sh /v2/api/add-vm-pci-nic /tmp/body.json
```
