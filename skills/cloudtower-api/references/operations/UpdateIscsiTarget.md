# POST /v2/api/update-iscsi-target
...
```bash
python3 scripts/validate.py UpdateIscsiTarget /tmp/body.json
bash scripts/call.sh /v2/api/update-iscsi-target /tmp/body.json
```
