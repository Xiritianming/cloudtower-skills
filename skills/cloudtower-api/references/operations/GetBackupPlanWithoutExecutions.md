# POST /v2/api/get-backup-plans-without-executions
...
python3 scripts/validate.py GetBackupPlanWithoutExecutions /tmp/body.json
bash scripts/call.sh /v2/api/get-backup-plans-without-executions /tmp/body.json
```
