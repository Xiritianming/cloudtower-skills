# POST /v2/api/get-v2-everoute-licenses
...
```bash
python3 scripts/validate.py GetV2EverouteLicenses /tmp/body.json
bash scripts/call.sh /v2/api/get-v2-everoute-licenses /tmp/body.json
```
