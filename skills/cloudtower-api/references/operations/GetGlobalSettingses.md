# POST /v2/api/get-global-settingses
...
```bash
python3 scripts/validate.py GetGlobalSettingses /tmp/body.json
bash scripts/call.sh /v2/api/get-global-settingses /tmp/body.json
```
