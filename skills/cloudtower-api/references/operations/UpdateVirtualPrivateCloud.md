# POST /v2/api/update-virtual-private-cloud
...
python3 scripts/validate.py UpdateVirtualPrivateCloud /tmp/body.json
bash scripts/call.sh /v2/api/update-virtual-private-cloud /tmp/body.json
```
