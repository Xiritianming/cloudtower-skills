# POST /v2/api/get-vcenter-accounts
...
```bash
python3 scripts/validate.py GetVcenterAccounts /tmp/body.json
bash scripts/call.sh /v2/api/get-vcenter-accounts /tmp/body.json
```
