# POST /v2/api/get-snapshot-plans-connection
...
```bash
python3 scripts/validate.py GetSnapshotPlansConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-snapshot-plans-connection /tmp/body.json
```
