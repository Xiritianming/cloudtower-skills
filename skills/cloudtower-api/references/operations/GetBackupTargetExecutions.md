# POST /v2/api/get-backup-target-executions
...
```bash
python3 scripts/validate.py GetBackupTargetExecutions /tmp/body.json
bash scripts/call.sh /v2/api/get-backup-target-executions /tmp/body.json
```
