# POST /v2/api/get-gpu-devices-connection
...
python3 scripts/validate.py GetGpuDevicesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-gpu-devices-connection /tmp/body.json
```
