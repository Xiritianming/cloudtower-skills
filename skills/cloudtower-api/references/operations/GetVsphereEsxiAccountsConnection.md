# POST /v2/api/get-vsphere-esxi-accounts-connection
...
```bash
python3 scripts/validate.py GetVsphereEsxiAccountsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-vsphere-esxi-accounts-connection /tmp/body.json
```
