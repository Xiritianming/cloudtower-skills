...
**Schema:** [GetClustersRequestBody](../schemas/Get/GetClustersRequestBody.md)
...
python3 scripts/validate.py GetClusters /tmp/body.json
bash scripts/call.sh /v2/api/get-clusters /tmp/body.json
```
...
Array of [Cluster](../schemas/Cluster/Cluster.md)
