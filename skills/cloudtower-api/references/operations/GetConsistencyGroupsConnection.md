# POST /v2/api/get-consistency-groups-connection
...
python3 scripts/validate.py GetConsistencyGroupsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-consistency-groups-connection /tmp/body.json
```
