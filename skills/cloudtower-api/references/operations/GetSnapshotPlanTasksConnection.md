# POST /v2/api/get-snapshot-plan-tasks-connection
...
```bash
python3 scripts/validate.py GetSnapshotPlanTasksConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-snapshot-plan-tasks-connection /tmp/body.json
```
