# POST /v2/api/clone-iscsi-lun-from-snapshot
...
```bash
python3 scripts/validate.py CloneIscsiLunFromSnapshot /tmp/body.json
bash scripts/call.sh /v2/api/clone-iscsi-lun-from-snapshot /tmp/body.json
```
