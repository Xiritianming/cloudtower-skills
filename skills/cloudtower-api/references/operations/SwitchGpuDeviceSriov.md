# POST /v2/api/switch-gpu-device-sriov

**Resource:** [GpuDevice](../resources/GpuDevice.md)
**Operation ID:** `SwitchGpuDeviceSriov`
...
**Schema:** [GpuDeviceSriovSwitchParams](../schemas/Gpu/GpuDeviceSriovSwitchParams.md)
...
python3 scripts/validate.py SwitchGpuDeviceSriov /tmp/body.json
bash scripts/call.sh /v2/api/switch-gpu-device-sriov /tmp/body.json
```
