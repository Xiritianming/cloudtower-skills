# POST /v2/api/get-export-file-download-links
...
```bash
python3 scripts/validate.py GetExportFileDownloadLinks /tmp/body.json
bash scripts/call.sh /v2/api/get-export-file-download-links /tmp/body.json
```
