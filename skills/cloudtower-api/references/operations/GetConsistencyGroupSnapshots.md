# POST /v2/api/get-consistency-group-snapshots
...
```bash
python3 scripts/validate.py GetConsistencyGroupSnapshots /tmp/body.json
bash scripts/call.sh /v2/api/get-consistency-group-snapshots /tmp/body.json
```
