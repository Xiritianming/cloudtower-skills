# POST /v2/api/force-restart-vm

**Resource:** [Vm](../resources/Vm.md)
**Operation ID:** `ForceRestartVm`
...
python3 scripts/validate.py ForceRestartVm /tmp/body.json
bash scripts/call.sh /v2/api/force-restart-vm /tmp/body.json
```
