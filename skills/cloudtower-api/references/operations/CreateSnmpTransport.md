# POST /v2/api/create-snmp-transport
...
python3 scripts/validate.py CreateSnmpTransport /tmp/body.json
bash scripts/call.sh /v2/api/create-snmp-transport /tmp/body.json
```
