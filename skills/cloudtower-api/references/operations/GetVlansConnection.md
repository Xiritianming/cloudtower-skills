# POST /v2/api/get-vlans-connection
...
```bash
python3 scripts/validate.py GetVlansConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-vlans-connection /tmp/body.json
```
