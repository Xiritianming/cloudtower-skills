# POST /v2/api/get-vm-network-metrics

**Resource:** [Metrics](../resources/Metrics.md)
**Operation ID:** `GetVmNetWorkMetrics`
...
**Schema:** [GetVmNetWorkMetricInput](../schemas/Get/GetVmNetWorkMetricInput.md)
...
python3 scripts/validate.py GetVmNetWorkMetrics /tmp/body.json
bash scripts/call.sh /v2/api/get-vm-network-metrics /tmp/body.json
```
