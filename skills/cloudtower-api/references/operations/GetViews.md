...
**Schema:** [GetViewsRequestBody](../schemas/Get/GetViewsRequestBody.md)
...
python3 scripts/validate.py GetViews /tmp/body.json
bash scripts/call.sh /v2/api/get-views /tmp/body.json
```
...
Array of [View](../schemas/View/View.md)
