# POST /v2/api/get-snmp-transports-connection
...
```bash
python3 scripts/validate.py GetSnmpTransportsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-snmp-transports-connection /tmp/body.json
```
