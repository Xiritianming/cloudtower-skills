# POST /v2/api/get-users-connection
...
python3 scripts/validate.py GetUsersConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-users-connection /tmp/body.json
```
