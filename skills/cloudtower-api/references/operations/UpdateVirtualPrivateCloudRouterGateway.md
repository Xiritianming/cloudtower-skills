# POST /v2/api/update-virtual-private-cloud-router-gateway

**Resource:** [VirtualPrivateCloudRouterGateway](../resources/VirtualPrivateCloudRouterGateway.md)
**Operation ID:** `UpdateVirtualPrivateCloudRouterGateway`
...
**Schema:** [VirtualPrivateCloudRouterGatewayUpdationParams](../schemas/Virtual/VirtualPrivateCloudRouterGatewayUpdationParams.md)
...
python3 scripts/validate.py UpdateVirtualPrivateCloudRouterGateway /tmp/body.json
bash scripts/call.sh /v2/api/update-virtual-private-cloud-router-gateway /tmp/body.json
```
