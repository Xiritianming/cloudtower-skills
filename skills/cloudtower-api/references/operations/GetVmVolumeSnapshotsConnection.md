# POST /v2/api/get-vm-volume-snapshots-connection
...
```bash
python3 scripts/validate.py GetVmVolumeSnapshotsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-vm-volume-snapshots-connection /tmp/body.json
```
