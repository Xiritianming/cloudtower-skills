# POST /v2/api/get-content-library-images
...
python3 scripts/validate.py GetContentLibraryImages /tmp/body.json
bash scripts/call.sh /v2/api/get-content-library-images /tmp/body.json
```
