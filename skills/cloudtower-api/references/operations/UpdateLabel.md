...
**Schema:** [LabelUpdationParams](../schemas/Label/LabelUpdationParams.md)
...
```bash
python3 scripts/validate.py UpdateLabel /tmp/body.json
bash scripts/call.sh /v2/api/update-label /tmp/body.json
```
