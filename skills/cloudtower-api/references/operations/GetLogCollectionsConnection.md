# POST /v2/api/get-log-collections-connection
...
```bash
python3 scripts/validate.py GetLogCollectionsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-log-collections-connection /tmp/body.json
```
