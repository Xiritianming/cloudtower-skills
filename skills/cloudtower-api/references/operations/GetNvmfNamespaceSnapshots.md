# POST /v2/api/get-nvmf-namespace-snapshots
...
python3 scripts/validate.py GetNvmfNamespaceSnapshots /tmp/body.json
bash scripts/call.sh /v2/api/get-nvmf-namespace-snapshots /tmp/body.json
```
