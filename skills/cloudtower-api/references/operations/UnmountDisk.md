# POST /v2/api/unmount-disk

**Resource:** [Disk](../resources/Disk.md)
**Operation ID:** `UnmountDisk`
...
**Schema:** [DiskUnmountParams](../schemas/Disk/DiskUnmountParams.md)
...
```bash
python3 scripts/validate.py UnmountDisk /tmp/body.json
bash scripts/call.sh /v2/api/unmount-disk /tmp/body.json
```
