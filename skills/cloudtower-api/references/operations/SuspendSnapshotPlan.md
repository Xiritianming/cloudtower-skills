# POST /v2/api/suspend-snapshot-plan
...
python3 scripts/validate.py SuspendSnapshotPlan /tmp/body.json
bash scripts/call.sh /v2/api/suspend-snapshot-plan /tmp/body.json
```
