# POST /v2/api/get-backup-services
...
```bash
python3 scripts/validate.py GetBackupServices /tmp/body.json
bash scripts/call.sh /v2/api/get-backup-services /tmp/body.json
```
