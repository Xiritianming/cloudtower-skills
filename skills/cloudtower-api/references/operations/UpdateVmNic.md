# POST /v2/api/update-vm-nic

**Resource:** [Vm](../resources/Vm.md)
**Operation ID:** `UpdateVmNic`
...
**Schema:** [VmUpdateNicParams](../schemas/Vm/VmUpdateNicParams.md)
...
python3 scripts/validate.py UpdateVmNic /tmp/body.json
bash scripts/call.sh /v2/api/update-vm-nic /tmp/body.json
```
