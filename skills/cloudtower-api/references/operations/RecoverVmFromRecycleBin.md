# POST /v2/api/recover-vm-from-recycle

**Resource:** [Vm](../resources/Vm.md)
**Operation ID:** `RecoverVmFromRecycleBin`
...
python3 scripts/validate.py RecoverVmFromRecycleBin /tmp/body.json
bash scripts/call.sh /v2/api/recover-vm-from-recycle /tmp/body.json
```
...
Array of [WithTask_DeleteVm_](../schemas/With/WithTask-DeleteVm.md)
