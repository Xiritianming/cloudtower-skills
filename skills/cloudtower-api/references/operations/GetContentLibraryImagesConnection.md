# POST /v2/api/get-content-library-images-connection
...
python3 scripts/validate.py GetContentLibraryImagesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-content-library-images-connection /tmp/body.json
```
