# POST /v2/api/get-detail-vm-info-by-gpu-devices
...
```bash
python3 scripts/validate.py GetDetailVmInfoByGpuDevices /tmp/body.json
bash scripts/call.sh /v2/api/get-detail-vm-info-by-gpu-devices /tmp/body.json
```
