# POST /v2/api/migrate-vm

**Resource:** [Vm](../resources/Vm.md)
**Operation ID:** `MigrateVm`
...
**Schema:** [VmMigrateParams](../schemas/Vm/VmMigrateParams.md)
...
```bash
python3 scripts/validate.py MigrateVm /tmp/body.json
bash scripts/call.sh /v2/api/migrate-vm /tmp/body.json
```
