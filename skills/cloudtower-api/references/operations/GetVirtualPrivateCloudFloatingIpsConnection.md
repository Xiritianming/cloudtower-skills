# POST /v2/api/get-virtual-private-cloud-floating-ips-connection
...
```bash
python3 scripts/validate.py GetVirtualPrivateCloudFloatingIpsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-virtual-private-cloud-floating-ips-connection /tmp/body.json
```
