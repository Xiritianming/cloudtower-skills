# POST /v2/api/convert-content-library-vm-template-from-vm
...
```bash
python3 scripts/validate.py ConvertContentLibraryVmTemplateFromVm /tmp/body.json
bash scripts/call.sh /v2/api/convert-content-library-vm-template-from-vm /tmp/body.json
```
