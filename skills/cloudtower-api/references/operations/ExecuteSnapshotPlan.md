# POST /v2/api/execute-snapshot-plan

**Resource:** [SnapshotPlan](../resources/SnapshotPlan.md)
**Operation ID:** `ExecuteSnapshotPlan`
...
**Schema:** [SnapshotPlanExecutionParams](../schemas/Snapshot/SnapshotPlanExecutionParams.md)
...
python3 scripts/validate.py ExecuteSnapshotPlan /tmp/body.json
bash scripts/call.sh /v2/api/execute-snapshot-plan /tmp/body.json
```
