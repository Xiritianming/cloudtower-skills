# POST /v2/api/get-global-alert-rules-connection
...
```bash
python3 scripts/validate.py GetGlobalAlertRulesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-global-alert-rules-connection /tmp/body.json
```
