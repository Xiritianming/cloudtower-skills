# POST /v2/api/get-organizations-connection
...
```bash
python3 scripts/validate.py GetOrganizationsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-organizations-connection /tmp/body.json
```
