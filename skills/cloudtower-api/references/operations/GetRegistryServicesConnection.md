# POST /v2/api/get-registry-services-connection
...
```bash
python3 scripts/validate.py GetRegistryServicesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-registry-services-connection /tmp/body.json
```
