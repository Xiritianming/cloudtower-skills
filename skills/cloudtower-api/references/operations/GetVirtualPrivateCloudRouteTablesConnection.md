# POST /v2/api/get-virtual-private-cloud-route-tables-connection
...
```bash
python3 scripts/validate.py GetVirtualPrivateCloudRouteTablesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-virtual-private-cloud-route-tables-connection /tmp/body.json
```
