# POST /v2/api/update-entity-filter
...
```bash
python3 scripts/validate.py UpdateEntityFilter /tmp/body.json
bash scripts/call.sh /v2/api/update-entity-filter /tmp/body.json
```
