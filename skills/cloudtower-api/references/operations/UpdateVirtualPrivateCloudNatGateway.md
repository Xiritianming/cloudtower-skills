# POST /v2/api/update-virtual-private-cloud-nat-gateway
...
```bash
python3 scripts/validate.py UpdateVirtualPrivateCloudNatGateway /tmp/body.json
bash scripts/call.sh /v2/api/update-virtual-private-cloud-nat-gateway /tmp/body.json
```
