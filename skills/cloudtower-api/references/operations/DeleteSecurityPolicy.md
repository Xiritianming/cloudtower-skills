# POST /v2/api/delete-security-policy
...
python3 scripts/validate.py DeleteSecurityPolicy /tmp/body.json
bash scripts/call.sh /v2/api/delete-security-policy /tmp/body.json
```
