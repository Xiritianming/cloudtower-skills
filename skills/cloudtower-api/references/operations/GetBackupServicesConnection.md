# POST /v2/api/get-backup-services-connection
...
```bash
python3 scripts/validate.py GetBackupServicesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-backup-services-connection /tmp/body.json
```
