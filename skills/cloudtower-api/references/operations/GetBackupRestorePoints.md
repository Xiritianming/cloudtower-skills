# POST /v2/api/get-backup-restore-points
...
```bash
python3 scripts/validate.py GetBackupRestorePoints /tmp/body.json
bash scripts/call.sh /v2/api/get-backup-restore-points /tmp/body.json
```
