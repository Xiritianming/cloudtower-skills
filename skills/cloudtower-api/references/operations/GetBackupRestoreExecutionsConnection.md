# POST /v2/api/get-backup-restore-executions-connection
...
```bash
python3 scripts/validate.py GetBackupRestoreExecutionsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-backup-restore-executions-connection /tmp/body.json
```
