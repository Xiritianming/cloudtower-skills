# POST /v2/api/get-nvmf-namespaces-connection
...
```bash
python3 scripts/validate.py GetNvmfNamespacesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-nvmf-namespaces-connection /tmp/body.json
```
