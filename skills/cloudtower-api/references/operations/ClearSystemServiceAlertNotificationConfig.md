# POST /v2/api/clear-system-service-alert-notification-config
...
```bash
python3 scripts/validate.py ClearSystemServiceAlertNotificationConfig /tmp/body.json
bash scripts/call.sh /v2/api/clear-system-service-alert-notification-config /tmp/body.json
```
