# POST /v2/api/get-hosts-connection
...
```bash
python3 scripts/validate.py GetHostsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-hosts-connection /tmp/body.json
```
