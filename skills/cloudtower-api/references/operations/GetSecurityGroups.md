# POST /v2/api/get-security-groups
...
```bash
python3 scripts/validate.py GetSecurityGroups /tmp/body.json
bash scripts/call.sh /v2/api/get-security-groups /tmp/body.json
```
