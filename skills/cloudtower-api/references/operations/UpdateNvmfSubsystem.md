# POST /v2/api/update-nvmf-subsystem
...
```bash
python3 scripts/validate.py UpdateNvmfSubsystem /tmp/body.json
bash scripts/call.sh /v2/api/update-nvmf-subsystem /tmp/body.json
```
