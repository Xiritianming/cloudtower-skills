# POST /v2/api/delete-snmp-transport
...
```bash
python3 scripts/validate.py DeleteSnmpTransport /tmp/body.json
bash scripts/call.sh /v2/api/delete-snmp-transport /tmp/body.json
```
