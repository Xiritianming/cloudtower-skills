# POST /v2/api/get-elf-storage-policies
...
```bash
python3 scripts/validate.py GetElfStoragePolicies /tmp/body.json
bash scripts/call.sh /v2/api/get-elf-storage-policies /tmp/body.json
```
