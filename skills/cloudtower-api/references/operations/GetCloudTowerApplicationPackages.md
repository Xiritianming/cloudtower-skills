# POST /v2/api/get-cloudtower-application-packages
...
python3 scripts/validate.py GetCloudTowerApplicationPackages /tmp/body.json
bash scripts/call.sh /v2/api/get-cloudtower-application-packages /tmp/body.json
```
