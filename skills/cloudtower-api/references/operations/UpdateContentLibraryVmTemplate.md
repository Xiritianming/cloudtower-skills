# POST /v2/api/update-content-library-vm-template
...
```bash
python3 scripts/validate.py UpdateContentLibraryVmTemplate /tmp/body.json
bash scripts/call.sh /v2/api/update-content-library-vm-template /tmp/body.json
```
