# POST /v2/api/get-nics-connection
...
```bash
python3 scripts/validate.py GetNicsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-nics-connection /tmp/body.json
```
