# POST /v2/api/get-svt-images-connection
...
```bash
python3 scripts/validate.py GetSvtImagesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-svt-images-connection /tmp/body.json
```
