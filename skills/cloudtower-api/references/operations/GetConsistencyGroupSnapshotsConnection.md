# POST /v2/api/get-consistency-group-snapshots-connection
...
```bash
python3 scripts/validate.py GetConsistencyGroupSnapshotsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-consistency-group-snapshots-connection /tmp/body.json
```
