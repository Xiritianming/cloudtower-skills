# POST /v2/api/get-system-audit-logs
...
```bash
python3 scripts/validate.py GetSystemAuditLogs /tmp/body.json
bash scripts/call.sh /v2/api/get-system-audit-logs /tmp/body.json
```
