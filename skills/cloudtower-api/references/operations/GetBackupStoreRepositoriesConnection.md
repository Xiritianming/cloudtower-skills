# POST /v2/api/get-backup-store-repositories-connection
...
```bash
python3 scripts/validate.py GetBackupStoreRepositoriesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-backup-store-repositories-connection /tmp/body.json
```
