# POST /v2/api/get-brick-topoes-connection
...
python3 scripts/validate.py GetBrickTopoesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-brick-topoes-connection /tmp/body.json
```
