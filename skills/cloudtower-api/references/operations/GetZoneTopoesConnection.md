# POST /v2/api/get-zone-topoes-connection
...
python3 scripts/validate.py GetZoneTopoesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-zone-topoes-connection /tmp/body.json
```
