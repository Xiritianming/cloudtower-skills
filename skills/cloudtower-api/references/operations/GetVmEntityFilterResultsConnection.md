# POST /v2/api/get-vm-entity-filter-results-connection
...
python3 scripts/validate.py GetVmEntityFilterResultsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-vm-entity-filter-results-connection /tmp/body.json
```
