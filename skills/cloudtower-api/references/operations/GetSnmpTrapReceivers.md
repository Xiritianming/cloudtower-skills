# POST /v2/api/get-snmp-trap-receivers
...
python3 scripts/validate.py GetSnmpTrapReceivers /tmp/body.json
bash scripts/call.sh /v2/api/get-snmp-trap-receivers /tmp/body.json
```
