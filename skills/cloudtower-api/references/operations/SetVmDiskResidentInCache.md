# POST /v2/api/set-vm-disk-resident-in-cache
...
```bash
python3 scripts/validate.py SetVmDiskResidentInCache /tmp/body.json
bash scripts/call.sh /v2/api/set-vm-disk-resident-in-cache /tmp/body.json
```
