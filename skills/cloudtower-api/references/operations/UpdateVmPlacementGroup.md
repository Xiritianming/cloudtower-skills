# POST /v2/api/update-vm-placement-group
...
python3 scripts/validate.py UpdateVmPlacementGroup /tmp/body.json
bash scripts/call.sh /v2/api/update-vm-placement-group /tmp/body.json
```
