# POST /v2/api/update-management-vlan
...
python3 scripts/validate.py UpdateManagementVlan /tmp/body.json
bash scripts/call.sh /v2/api/update-management-vlan /tmp/body.json
```
