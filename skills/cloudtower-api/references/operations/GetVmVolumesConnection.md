# POST /v2/api/get-vm-volumes-connection
...
```bash
python3 scripts/validate.py GetVmVolumesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-vm-volumes-connection /tmp/body.json
```
