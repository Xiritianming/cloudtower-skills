# POST /v2/api/get-nvmf-namespaces
...
```bash
python3 scripts/validate.py GetNvmfNamespaces /tmp/body.json
bash scripts/call.sh /v2/api/get-nvmf-namespaces /tmp/body.json
```
