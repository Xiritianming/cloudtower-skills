# POST /v2/api/delete-organization
...
```bash
python3 scripts/validate.py DeleteOrganization /tmp/body.json
bash scripts/call.sh /v2/api/delete-organization /tmp/body.json
```
