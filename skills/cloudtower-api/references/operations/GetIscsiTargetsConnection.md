# POST /v2/api/get-iscsi-targets-connection
...
```bash
python3 scripts/validate.py GetIscsiTargetsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-iscsi-targets-connection /tmp/body.json
```
