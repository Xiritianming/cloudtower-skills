# POST /v2/api/update-nvmf-namespace
...
```bash
python3 scripts/validate.py UpdateNvmfNamespace /tmp/body.json
bash scripts/call.sh /v2/api/update-nvmf-namespace /tmp/body.json
```
