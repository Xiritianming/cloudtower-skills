# POST /v2/api/get-zones-connection
...
```bash
python3 scripts/validate.py GetZonesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-zones-connection /tmp/body.json
```
