# POST /v2/api/remove-vm-disk

**Resource:** [Vm](../resources/Vm.md)
**Operation ID:** `RemoveVmDisk`
...
**Schema:** [VmRemoveDiskParams](../schemas/Vm/VmRemoveDiskParams.md)
...
python3 scripts/validate.py RemoveVmDisk /tmp/body.json
bash scripts/call.sh /v2/api/remove-vm-disk /tmp/body.json
```
