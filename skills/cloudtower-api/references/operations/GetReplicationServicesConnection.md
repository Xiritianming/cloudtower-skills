# POST /v2/api/get-replication-services-connection
...
```bash
python3 scripts/validate.py GetReplicationServicesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-replication-services-connection /tmp/body.json
```
