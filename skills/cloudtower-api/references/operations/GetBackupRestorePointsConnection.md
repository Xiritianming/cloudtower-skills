# POST /v2/api/get-backup-restore-points-connection
...
python3 scripts/validate.py GetBackupRestorePointsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-backup-restore-points-connection /tmp/body.json
```
