# POST /v2/api/remove-content-library-vm-template-clusters
...
python3 scripts/validate.py RemoveContentLibraryVmTemplateClusters /tmp/body.json
bash scripts/call.sh /v2/api/remove-content-library-vm-template-clusters /tmp/body.json
```
