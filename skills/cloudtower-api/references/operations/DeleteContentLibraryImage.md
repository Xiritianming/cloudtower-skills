# POST /v2/api/delete-content-library-image
...
```bash
python3 scripts/validate.py DeleteContentLibraryImage /tmp/body.json
bash scripts/call.sh /v2/api/delete-content-library-image /tmp/body.json
```
