# POST /v2/api/get-alert-notifiers
...
```bash
python3 scripts/validate.py GetAlertNotifiers /tmp/body.json
bash scripts/call.sh /v2/api/get-alert-notifiers /tmp/body.json
```
