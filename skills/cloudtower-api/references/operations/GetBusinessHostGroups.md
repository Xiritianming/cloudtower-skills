# POST /v2/api/get-business-host-groups
...
python3 scripts/validate.py GetBusinessHostGroups /tmp/body.json
bash scripts/call.sh /v2/api/get-business-host-groups /tmp/body.json
```
