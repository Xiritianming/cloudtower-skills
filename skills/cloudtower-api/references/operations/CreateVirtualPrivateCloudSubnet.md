# POST /v2/api/create-virtual-private-cloud-subnet
...
python3 scripts/validate.py CreateVirtualPrivateCloudSubnet /tmp/body.json
bash scripts/call.sh /v2/api/create-virtual-private-cloud-subnet /tmp/body.json
```
