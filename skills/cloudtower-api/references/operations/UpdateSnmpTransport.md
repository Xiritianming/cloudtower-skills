# POST /v2/api/update-snmp-transport
...
python3 scripts/validate.py UpdateSnmpTransport /tmp/body.json
bash scripts/call.sh /v2/api/update-snmp-transport /tmp/body.json
```
