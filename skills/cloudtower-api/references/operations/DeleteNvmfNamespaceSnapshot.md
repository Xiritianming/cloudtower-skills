# POST /v2/api/delete-nvmf-namespace-snapshot
...
```bash
python3 scripts/validate.py DeleteNvmfNamespaceSnapshot /tmp/body.json
bash scripts/call.sh /v2/api/delete-nvmf-namespace-snapshot /tmp/body.json
```
