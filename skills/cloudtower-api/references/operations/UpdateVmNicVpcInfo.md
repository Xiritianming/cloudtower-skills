# POST /v2/api/update-vm-vpc-nic

**Resource:** [Vm](../resources/Vm.md)
**Operation ID:** `UpdateVmNicVpcInfo`
...
**Schema:** [VmUpdateVpcNicParams](../schemas/Vm/VmUpdateVpcNicParams.md)
...
python3 scripts/validate.py UpdateVmNicVpcInfo /tmp/body.json
bash scripts/call.sh /v2/api/update-vm-vpc-nic /tmp/body.json
```
