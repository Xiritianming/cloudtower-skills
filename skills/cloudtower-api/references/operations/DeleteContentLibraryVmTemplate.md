# POST /v2/api/delete-content-library-vm-template
...
```bash
python3 scripts/validate.py DeleteContentLibraryVmTemplate /tmp/body.json
bash scripts/call.sh /v2/api/delete-content-library-vm-template /tmp/body.json
```
