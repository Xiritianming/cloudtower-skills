# POST /v2/api/get-snapshot-plan-tasks
...
```bash
python3 scripts/validate.py GetSnapshotPlanTasks /tmp/body.json
bash scripts/call.sh /v2/api/get-snapshot-plan-tasks /tmp/body.json
```
