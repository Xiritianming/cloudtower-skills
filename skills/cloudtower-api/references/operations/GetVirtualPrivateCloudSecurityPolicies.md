# POST /v2/api/get-virtual-private-cloud-security-policies
...
```bash
python3 scripts/validate.py GetVirtualPrivateCloudSecurityPolicies /tmp/body.json
bash scripts/call.sh /v2/api/get-virtual-private-cloud-security-policies /tmp/body.json
```
