# POST /v2/api/update-report-template
...
```bash
python3 scripts/validate.py UpdateReportTemplate /tmp/body.json
bash scripts/call.sh /v2/api/update-report-template /tmp/body.json
```
