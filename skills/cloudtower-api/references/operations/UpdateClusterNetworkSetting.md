# POST /v2/api/update-cluster-network-setting
...
```bash
python3 scripts/validate.py UpdateClusterNetworkSetting /tmp/body.json
bash scripts/call.sh /v2/api/update-cluster-network-setting /tmp/body.json
```
