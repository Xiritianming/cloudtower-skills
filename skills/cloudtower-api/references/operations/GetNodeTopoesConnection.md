# POST /v2/api/get-node-topoes-connection
...
```bash
python3 scripts/validate.py GetNodeTopoesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-node-topoes-connection /tmp/body.json
```
