# POST /v2/api/get-vm-placement-groups
...
```bash
python3 scripts/validate.py GetVmPlacementGroups /tmp/body.json
bash scripts/call.sh /v2/api/get-vm-placement-groups /tmp/body.json
```
