# POST /v2/api/get-replication-plans

**Resource:** [ReplicationPlan](../resources/ReplicationPlan.md)
**Operation ID:** `GetReplicationPlans`
...
```bash
python3 scripts/validate.py GetReplicationPlans /tmp/body.json
bash scripts/call.sh /v2/api/get-replication-plans /tmp/body.json
```
