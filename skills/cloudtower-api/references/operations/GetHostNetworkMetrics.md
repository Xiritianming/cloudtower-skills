# POST /v2/api/get-host-network-metrics

**Resource:** [Metrics](../resources/Metrics.md)
**Operation ID:** `GetHostNetworkMetrics`
...
**Schema:** [GetHostNetworkMetricInput](../schemas/Get/GetHostNetworkMetricInput.md)
...
python3 scripts/validate.py GetHostNetworkMetrics /tmp/body.json
bash scripts/call.sh /v2/api/get-host-network-metrics /tmp/body.json
```
