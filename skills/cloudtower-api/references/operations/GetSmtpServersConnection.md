# POST /v2/api/get-smtp-servers-connection
...
```bash
python3 scripts/validate.py GetSmtpServersConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-smtp-servers-connection /tmp/body.json
```
