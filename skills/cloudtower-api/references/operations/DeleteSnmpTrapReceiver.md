# POST /v2/api/delete-snmp-trap-receiver
...
```bash
python3 scripts/validate.py DeleteSnmpTrapReceiver /tmp/body.json
bash scripts/call.sh /v2/api/delete-snmp-trap-receiver /tmp/body.json
```
