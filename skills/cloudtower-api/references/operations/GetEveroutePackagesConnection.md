# POST /v2/api/get-everoute-packages-connection
...
python3 scripts/validate.py GetEveroutePackagesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-everoute-packages-connection /tmp/body.json
```
