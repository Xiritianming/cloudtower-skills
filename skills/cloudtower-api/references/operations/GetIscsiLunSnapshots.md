# POST /v2/api/get-iscsi-lun-snapshots
...
```bash
python3 scripts/validate.py GetIscsiLunSnapshots /tmp/body.json
bash scripts/call.sh /v2/api/get-iscsi-lun-snapshots /tmp/body.json
```
