# POST /v2/api/get-replication-services
...
```bash
python3 scripts/validate.py GetReplicationServices /tmp/body.json
bash scripts/call.sh /v2/api/get-replication-services /tmp/body.json
```
