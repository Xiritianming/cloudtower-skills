# POST /v2/api/get-virtual-private-cloud-edge-gateways
...
```bash
python3 scripts/validate.py GetVirtualPrivateCloudEdgeGateways /tmp/body.json
bash scripts/call.sh /v2/api/get-virtual-private-cloud-edge-gateways /tmp/body.json
```
