# POST /v2/api/get-alerts-connection
...
python3 scripts/validate.py GetAlertsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-alerts-connection /tmp/body.json
```
