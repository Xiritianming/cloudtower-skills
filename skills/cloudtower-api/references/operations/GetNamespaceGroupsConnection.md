# POST /v2/api/get-namespace-groups-connection
...
```bash
python3 scripts/validate.py GetNamespaceGroupsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-namespace-groups-connection /tmp/body.json
```
