# POST /v2/api/get-usb-devices-connection
...
```bash
python3 scripts/validate.py GetUsbDevicesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-usb-devices-connection /tmp/body.json
```
