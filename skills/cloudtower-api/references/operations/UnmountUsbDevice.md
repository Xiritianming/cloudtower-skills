# POST /v2/api/unmount-usb-device

**Resource:** [UsbDevice](../resources/UsbDevice.md)
**Operation ID:** `UnmountUsbDevice`
...
**Schema:** [UsbDeviceUnmountParams](../schemas/Usb/UsbDeviceUnmountParams.md)
...
python3 scripts/validate.py UnmountUsbDevice /tmp/body.json
bash scripts/call.sh /v2/api/unmount-usb-device /tmp/body.json
```
