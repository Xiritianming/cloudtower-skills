# POST /v2/api/get-security-policies-connection
...
python3 scripts/validate.py GetSecurityPoliciesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-security-policies-connection /tmp/body.json
```
