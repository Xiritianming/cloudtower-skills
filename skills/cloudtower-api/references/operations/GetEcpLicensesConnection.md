# POST /v2/api/get-ecp-licenses-connection
...
```bash
python3 scripts/validate.py GetEcpLicensesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-ecp-licenses-connection /tmp/body.json
```
