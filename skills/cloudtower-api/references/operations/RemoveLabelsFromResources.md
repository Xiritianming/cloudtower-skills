# POST /v2/api/remove-labels-from-resources
...
python3 scripts/validate.py RemoveLabelsFromResources /tmp/body.json
bash scripts/call.sh /v2/api/remove-labels-from-resources /tmp/body.json
```
