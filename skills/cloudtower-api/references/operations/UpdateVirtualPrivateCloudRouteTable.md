# POST /v2/api/update-virtual-private-cloud-route-table
...
```bash
python3 scripts/validate.py UpdateVirtualPrivateCloudRouteTable /tmp/body.json
bash scripts/call.sh /v2/api/update-virtual-private-cloud-route-table /tmp/body.json
```
