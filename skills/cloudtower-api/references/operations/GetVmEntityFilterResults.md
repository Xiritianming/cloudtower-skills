# POST /v2/api/get-vm-entity-filter-results
...
```bash
python3 scripts/validate.py GetVmEntityFilterResults /tmp/body.json
bash scripts/call.sh /v2/api/get-vm-entity-filter-results /tmp/body.json
```
