# POST /v2/api/get-virtual-private-cloud-security-policies-connection
...
python3 scripts/validate.py GetVirtualPrivateCloudSecurityPoliciesConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-virtual-private-cloud-security-policies-connection /tmp/body.json
```
