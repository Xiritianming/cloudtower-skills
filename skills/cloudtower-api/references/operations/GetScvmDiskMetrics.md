# POST /v2/api/get-scvm-disk-metrics
...
```bash
python3 scripts/validate.py GetScvmDiskMetrics /tmp/body.json
bash scripts/call.sh /v2/api/get-scvm-disk-metrics /tmp/body.json
```
