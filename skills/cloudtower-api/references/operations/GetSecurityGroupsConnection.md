# POST /v2/api/get-security-groups-connection
...
python3 scripts/validate.py GetSecurityGroupsConnection /tmp/body.json
bash scripts/call.sh /v2/api/get-security-groups-connection /tmp/body.json
```
