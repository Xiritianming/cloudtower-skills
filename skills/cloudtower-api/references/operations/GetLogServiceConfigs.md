# POST /v2/api/get-log-service-configs
...
```bash
python3 scripts/validate.py GetLogServiceConfigs /tmp/body.json
bash scripts/call.sh /v2/api/get-log-service-configs /tmp/body.json
```
