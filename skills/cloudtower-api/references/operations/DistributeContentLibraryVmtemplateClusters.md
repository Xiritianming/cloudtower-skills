# POST /v2/api/distribute-content-library-vm-template-clusters

**Resource:** [ContentLibraryVmTemplate](../resources/ContentLibraryVmTemplate.md)
**Operation ID:** `DistributeContentLibraryVmtemplateClusters`
...
python3 scripts/validate.py DistributeContentLibraryVmtemplateClusters /tmp/body.json
bash scripts/call.sh /v2/api/distribute-content-library-vm-template-clusters /tmp/body.json
```
